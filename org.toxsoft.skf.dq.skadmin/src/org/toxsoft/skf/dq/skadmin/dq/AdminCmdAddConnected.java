...
/**
 * Команда s5admin: добавить {@link Gwid}-идентификаторы ресурсов из списка ресурсов подключенных к текущей сессии.
 *
 * @author mvk
 */
public class AdminCmdAddConnected
    extends AbstractAdminCmd {

  /**
   * Конструктор
   */
  public AdminCmdAddConnected() {
  ...
  public void doExec( IStringMap<IPlexyValue> aArgValues, IAdminCmdCallback aCallback ) {
    ...
    try {
      ...
      service.addConnectedResources( gwids );
